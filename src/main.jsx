...
const statusMeta = {
  confirmed: { label: "Viaja", short: "Sí", color: "#16825d", Icon: CheckCircle2 },
  declined: { label: "No viaja", short: "No", color: "#c2412f", Icon: XCircle },
  pending: { label: "Falta confirmar", short: "Pendiente", color: "#b7791f", Icon: AlertCircle }
};
...
function MetricCard({ label, value, status, helper }) {
  ...
  return (
    <article className="metric-card">
      ...
      <div className="metric-value" style={{ color: meta?.color || "#111827" }}>
        {value}
      </div>
  ...
  useEffect(() => {
    ...
    fetch(RESPONSE_SOURCE)
      ...
      .then((text) => {
        ...
        setSourceLabel("Respuestas leídas desde /data/respuestas_form.csv");
      })
      .catch(() => setSourceLabel("Cargá el CSV exportado del Form para comparar"));
  }, []);
    ...
    <div className="app-shell">
      <header className="hero">
        <div className="hero-copy">
          ...
          <p>
            Panel interactivo para cruzar la nómina oficial con las respuestas del Form:
            quién viaja, quién no, quién falta y qué casos necesitan revisión especial.
          </p>
        </div>
      ...
      <main className="main-grid">
        <section className="metrics-grid">
          <MetricCard label="Total nómina" value={summary.total} helper="Alumnos de 4A y 4B" />
          ...
          <MetricCard label="Con observación" value={summary.special} helper="Descuento, liberado o hermanos" />
        </section>
        ...
        <section className="panel controls-panel">
          <div className="search-control">
            ...
            <input
              ...
              placeholder="Buscar alumno u observación"
            />
          </div>
          <div className="select-group">
            ...
            <button type="button" onClick={exportPending}>
              <Download size={16} />
              Exportar vista
            </button>
          </div>
